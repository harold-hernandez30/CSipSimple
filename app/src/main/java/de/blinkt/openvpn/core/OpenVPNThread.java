...
public class OpenVPNThread implements Runnable {
	...
	public void run() {
		try {
			...
			VpnStatus.updateStateString("NOPROCESS", "No process running.", R.string.no_process, ConnectionStatus.LEVEL_NOTCONNECTED);
			if(mDumpPath!=null) {
				try {
					...
					logout.close();
					VpnStatus.logError("Mini dumb generated");
				} catch (IOException e) {
